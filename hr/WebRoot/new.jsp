...
<body>
	...
	<div class="content">
		...
		<form action="staffController_save" method="post">
			<div>
				<label>姓名</label>
				<input name="name" placeholder="员工信息" required="required">
			</div>
			<div>
				<label>职位</label>
				<select name="job">
			...
			<div>
				<label>电子邮件</label>
				<input name="email" placeholder="电子邮件" required="required">
			</div>
			<div>
				<label>手机号</label>
				<input name="phone" placeholder="手机号" required="required">
			</div>
			<div>
